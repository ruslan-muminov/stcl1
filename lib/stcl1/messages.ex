defmodule Stcl1.Messages do
  ...
  def message(:q_shows_list),
    do: "Наше расписание вы можете посмотреть на [сайте](https://standupclub.ru) или в [социальных сетях](https://t.me/Standupclubru). А можно чтобы ему автоматически всплывали? Это технически возможно?"
